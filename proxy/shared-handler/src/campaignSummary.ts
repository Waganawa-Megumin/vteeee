...
- 電光掲示板らしく、各要素の頭にデータに対応した絵文字を必ず付ける（📊規模=iocCount / 🔴悪性=malicious / 🟠疑わしい=suspicious / ⚠️CVE=topCves・distinctCves / 🌍国=topCountries / 🧩種別=byType / 📈増加・📉減少=recentChanges）。全体で3〜6個。無関係な絵文字の乱用や顔文字は避ける。
